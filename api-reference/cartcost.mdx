...
`tax`: [Price](https://rye-docs.readme.io/api-reference/price)
...
`shipping`: [Price](https://rye-docs.readme.io/api-reference/price)

The shipping amount for the customer to pay at checkout

---

`total`: [Price](https://rye-docs.readme.io/api-reference/price)
