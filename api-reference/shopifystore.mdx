...
`cartLines`: [\[ShopifyCartLine!\]!](https://rye-docs.readme.io/reference/shopifycartline)
...
`offer`: [ShopifyOffer](https://rye-docs.readme.io/reference/shopifyoffer-1)
...
`errors`: [\[ShopifyStoreError!\]!](/reference/shopifystoreerror)
