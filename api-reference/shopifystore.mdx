...
`cartLines`: [\[ShopifyCartLine!\]!](https://rye-docs.readme.io/api-reference/shopifycartline)

An array of [ShopifyCartLine](https://rye-docs.readme.io/api-reference/shopifycartline) objects, each representing a line item in the cart with the Shopify product variant details and the quantity of the variant.

---

`offer`: [ShopifyOffer](https://rye-docs.readme.io/api-reference/shopifyoffer-1)
