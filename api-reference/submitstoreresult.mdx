...
`store`: [Store!](https://rye-docs.readme.io/api-reference/store)

This field represents the store's information for which the cart submission result is provided.

---

`status`: [SubmitStoreStatus!](https://rye-docs.readme.io/api-reference/submitstorestatus)
...
`errors`: [\[SubmitStoreResultError!\]](/api-reference/submitstoreresulterror)
