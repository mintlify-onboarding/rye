...
`stores`: [\[Store!\]!](https://rye-docs.readme.io/api-reference/store)

An array of [Store](https://rye-docs.readme.io/api-reference/store) objects (either [AmazonStore](https://rye-docs.readme.io/api-reference/amazonstore) or [ShopifyStore](https://rye-docs.readme.io/api-reference/shopifystore)), each representing a store with items in the cart. Each store object contains its own specific data, such as store name, cart lines, and offer information.

---

`buyerIdentity`: [BuyerIdentity](https://rye-docs.readme.io/api-reference/buyeridentity)
...
`cost`: [CartCost](/api-reference/cartcost)
...
[getCart(id: ID!)](https://rye-docs.readme.io/api-reference/cart-1)
