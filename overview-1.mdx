...
<Note>
   **Documentation**
   * [Creating carts](/api-reference/createcart)
   * [Deleting carts](/api-reference/removecart)
   * [Submitting carts](/api-reference/submitcart)
</Note>
...
<Note>
   ...
   * [Add an item to cart](/api-reference/addcartitems)
   * [Delete an item from a cart](/api-reference/deletecartitems)
   * [Update an item in a cart](/api-reference/updatecartitems)
</Note>
...
<Note>
   ...
   * [Get cart via cart ID](/api-reference/cart-1)
</Note>
...
* Check out the [documentation](/api-reference/cart-1) to start using the Rye API
