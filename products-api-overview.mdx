...
The product data can be combined with the ability to place orders for those products via our [Cart API](/docs/order), to build powerful and complete eCommerce experiences anywhere.

[You can find the full list of product data available here](/docs/amazon-and-shopify-product-comparison).
...
| ------------------- | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| Individual products | Product page [URL](/reference/requestproductbyurlinput-1) and [marketplace](/reference/requestproductbyurlinput-1) | [https://www.allbirds.com/products/mens-tree-runners](https://www.allbirds.com/products/mens-tree-runners), SHOPIFY | [requestProductByURL](/reference/requestproductbyurl) |
| Whole stores        | Merchant store [URL](/reference/requestproductbyurlinput)                                                          | [https://www.allbirds.com](https://www.allbirds.com)                                                                | [requestStoreByURL](/reference/requeststorebyurl)     |
...
| --------------------- | --------------------------------------------------------------------------------------- | ------------------------------------------- | -------------------------------------------------- |
| Individual products   | Product [id](/reference/productbyidinput)and [marketplace](/reference/productbyidinput) | 6767362474059, SHOPIFY;B07H2V5YLH, AMAZON   | [productByID](/reference/productbyid)              |
| Whole stores          | Merchant store [domain](/reference/productsbydomaininput)                               | [www.allbirds.com](http://www.allbirds.com) | [productByDomainV2](/reference/productsbydomainv2) |
...
* Use our [tutorial](/docs/tutorial) to practice how to use the Product API (Requires API Key)
